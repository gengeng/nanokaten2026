...
function startAutoGenerateTimer() {
  ...
  // カウントダウン表示スケジュール：残り2:00、1:00、0:10 で10秒間表示
  const countdownTriggers = [120, 60, 10]; // 秒
...
const BUTTON_STATES = {
  ...
  countdown:  { ja: '自動更新まであと{time}', en: 'Auto-update in {time}', isIdle: true,  countdown: true  },
